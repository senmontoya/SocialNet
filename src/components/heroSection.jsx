        ...
        <section className="hero-section">
            <div className="container d-flex align-items-center justify-content-center fs-1 text-white flex-column">
                ...
                <h2 style={{ fontSize: '1.2rem', textAlign: 'center' }}>
                    Tu espacio para conectar, compartir y descubrir lo que más te apasiona. 
                    ¡Estamos emocionados de que formes parte de nuestra comunidad! No olvides explorar, 
                    interactuar y, por supuesto, disfrutar de cada momento. ¡Haz de SocialNet tu lugar para estar!
                </h2>
